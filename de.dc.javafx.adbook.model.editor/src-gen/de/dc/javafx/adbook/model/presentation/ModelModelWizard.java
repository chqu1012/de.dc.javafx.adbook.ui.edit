...
import de.dc.javafx.adbook.model.provider.ModelEditPlugin;
		...
		public void createControl(Composite parent) {
			...
			resourceURIBrowseFileSystemButton.addSelectionListener(new SelectionAdapter() {
				...
				public void widgetSelected(SelectionEvent event) {
					String[] filters = ModelEditor.FILE_EXTENSION_FILTERS
							.toArray(new String[ModelEditor.FILE_EXTENSION_FILTERS.size()]);
