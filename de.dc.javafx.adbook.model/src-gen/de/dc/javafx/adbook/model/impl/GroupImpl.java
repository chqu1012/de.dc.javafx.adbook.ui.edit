 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.javafx.adbook.model.impl.GroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.dc.javafx.adbook.model.impl.GroupImpl#getContacts <em>Contacts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupImpl extends MinimalEObjectImpl.Container implements Group {
	...
	public EList<Contact> getContacts() {
		if (contacts == null) {
			contacts = new EObjectResolvingEList<Contact>(Contact.class, this, ModelPackage.GROUP__CONTACTS);
		}
		return contacts;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ModelPackage.GROUP__NAME:
			return getName();
		case ModelPackage.GROUP__CONTACTS:
			return getContacts();
		}
